...
- (NSMutableData*) createMutableHTTPBodyData:(NSData*)data payload:(id<KGObjectProtocol>)payload dispositionName:(NSString*)name fileName:(NSString*)filename{
...
- (NSURLRequest *)createRequestWithPathComponent:(NSArray *)pathComponent payload:(id<KGObjectProtocol>)payload localFileUrl:(NSURL *)fileURL dispositionName:(NSString *)name{
...
- (NSURLRequest*) createRequestWithPathComponent:(NSArray*)pathComponent payload:(id<KGObjectProtocol>)payload fileData:(NSData*)data dispositionName:(NSString*)name fileName:(NSString*)filename{
