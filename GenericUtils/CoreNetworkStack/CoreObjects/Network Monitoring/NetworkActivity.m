...
- (BOOL)isWWANReachable{
    ...
    if(_iswwanreachable) {
        NSLog(@"Network Activity => Cellular Data");
    }
...
- (BOOL)isInternetReachable{
    ...
    BOOL isTrue = [self isHostReachable] || [self isWifiReachable] || [self isWWANReachable];
    return isTrue;
}
