...
- (id)copyWithZone:(NSZone *)zone{
    ...
    KGObject *copy = [[[self class] alloc] init];
    ...
    if (copy) {
        ...
        @catch (NSException *exception) {
            [CDExceptionLog message:@"%@",[exception reason]];
        }
    }
...
- (void)updateValue:(id)value forKey:(NSString*)key{
    ...
    if (property != NULL) {
        ...
        if ( [encodeType isSubclassOfClass:[KGObject class]]
            ...
            [(KGObject*)dyanaVal updateWithInfo:value];
        ...
        [CDDebugLog message:@"%@ property not found. So added to the FatBoy",key];
        [self setValue:value forKey:key];
    }
}
...
- (id) serializeValue:(id)value forKey:(NSString*)key{
    ...
    if ([value isKindOfClass:[KGObject class]]) {
        
        result = [(KGObject*)value serializeIntoInfo];
    }
        ...
        [CDDebugLog message:@"Root Key : %@ of encode type :: %@ has failed to parse." ,key, NSStringFromClass([value class])];
        result = [NSNull null];
    }
...
- (NSArray*) recursiveArraySerializer:(NSArray*)value{
    ...
    for (id item in value) {
        ...
        if ([item isKindOfClass:[NSArray class]]) {
        ...
        else if ([item isKindOfClass:[KGObject class]]) {
            ...
            [CDDebugLog message:@"Leef Item of encode type :: %@ has failed to parse.",NSStringFromClass([item class])];
...
- (NSDictionary*) recursiveDictionarySerializer:(NSDictionary*)value{
    ...
    for (id key in allKeys) {
        ...
        if ([item isKindOfClass:[NSArray class]]) {
            ...
            [CDDebugLog message:@"Leef Key : %@ of encode type :: %@ has failed to parse.", key, NSStringFromClass([item class])];
