...
public class Transaction: NSObject, TransactionProcessingProtocol{
    ...
    public func execute(_ success: @escaping ((_ next: TransactionProcessingProtocol?, _ previousResponse: [KGObjectProtocol]?) -> Void), failed: @escaping ((_ abort: Bool, _ reason: Response) -> Void)) -> Void {
